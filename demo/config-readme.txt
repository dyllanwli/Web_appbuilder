...

{
  ...
  //define the layout of onscreen widget and map. if this property does not exist, use the absolut layout
  //this layout does not affect the element whose position is relative to map
  //the widget manager can define whether or not to use the panel/position properties in widgetOnScreen section.
  //widget in pool is still controlled by controller
  "layoutDefinition": {
    //BorderContainer, TabContainer, StackContainer,
    "manager": "",
    ...
    //for BorderContainer
    "layout": {
      //each region can be a nested layout of a id, which is on screen id or map
      "heading": {
        "manager":,
        "layout":
      },
  ...
  "dataSource": {
    ...
    "dataSources": {
      'data source id': {
        ...
        //if it's added through external data source, it's:
        //  external~<id>
        id: "",

        //the filter expression applied to layer or external datasource
        filter: "",
        ...
        //url and dataSchema is an either-or property.
        //If use url, means the data source is from remote;
        //If use dataSchema, means data source is generated from client;
        url: "",
